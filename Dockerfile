...
# older python
RUN apt-get update -y && apt install --reinstall software-properties-common && add-apt-repository ppa:deadsnakes/ppa && apt update -y && apt install python3.7 python3.7-venv python3.7-dev python3-setuptools -y
