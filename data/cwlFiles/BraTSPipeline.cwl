...
inputs:
  ...
  skullStrip:
    ...
    inputBinding:
      position: 1
      prefix: -s
    doc: Flag whether to skull strip or not.Defaults to 1.This uses BrainMaGe [https://github.com/CBICA/BrainMaGe/] and.falls back to DeepMedic [https://cbica.github.io/CaPTk/seg_DL.html].
  brainTumor:
    type: boolean?
    label: 0 or 1
    inputBinding:
      position: 1
      prefix: -b
    doc: "Flag whether to segment brain tumors or not.Defaults to 0.This uses DeepMedic: https://cbica.github.io/CaPTk/seg_DL.html."
  debug:
    type: boolean?
    label: 0 or 1
    inputBinding:
