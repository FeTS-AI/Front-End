...
namespace CAPTK
{
  ...
  enum SegmentationAlgorithmsEnum
  {
    DeepMedic, UNet3D, UNet3DRes, BratsAlgo4, BratsAlgo5, SegAlgosMax
  };

  static const char SegmentationAlgorithmsString[SegAlgosMax + 1][30] =
  {
    "DeepMedic", "3DUNet", "3DResUNet", "BratsAlgo4", "BratsAlgo5", "SegAlgosMax"
  };

  enum FusionAlgorithmsEnum
  {
    Average, Simple, STAPLE, GxBoost, FusAlgosMax
  };

  static const char FusionAlgorithmsString[FusAlgosMax + 1][30] =
  {
    "Majority Voting", "SIMPLE", "STAPLE", "XGBoost", "FusAlgosMax"
  };

  enum TrainingSegmentationAlgorithmsEnum
  {
    train_DeepMedic, train_UNet3D, train_UNet3DRes, train_SegAlgosMax
  };

  static const char TrainingSegmentationAlgorithmsString[FusAlgosMax + 1][30] =
  {
    "DeepMedic", "3DUNet", "3DResUNet", "SegAlgosMax"
  };
