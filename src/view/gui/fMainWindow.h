...
private:
  ...
  fSegmentationPanel *segmentationPanel;
  fTrainingPanel* trainingPanel;
...
public slots:
  //! connection to segmentation panel
  void OnSegmentationClicked();

  //! connection to trainng panel
  ...
  */
  ...
  {
    return /*tumorPanel->mTumorPointsSelected*/0;
  }
