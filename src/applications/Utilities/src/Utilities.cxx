...
int algorithmsRunner()
{
  ...
  {    
...
#else
    m_exe = cbica::getExecutablePath() + "../Resources/bin/dcm2niix"
#endif
#endif
#else
#if WIN32
    ...
    //construct command
    std::string fullCommandToRun = cbica::normPath(m_exe) + " -o " + cbica::normPath(outputImageFile) + " -z y " + cbica::normPath(dicomFolderPath);
